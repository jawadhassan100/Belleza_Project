        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4 text-gray-600">
            ...
            <div className="bg-yellow-100 border border-yellow-300 text-yellow-800 p-4 rounded-md text-sm">
              📬 <strong>Important:</strong> Please check your <strong>Spam</strong> or <strong>Junk</strong> folder if you don't see our email in your inbox.
              <br />
              💡 Also, click <strong>"Report not as spam"</strong> or <strong>"Move to Inbox"</strong> to make sure you receive future updates.
            </div>
